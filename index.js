...
/* Task 4: Create a function called `
      removeArtist ` that takes two arguments:
 *     (1) artists array
 *     (2) a number which is the desired index in the array.
...
/* Task 7: Create a function called `
      addArtist ` that can accept an array of information and add it to the artists array. Then, Add a 21st artist to the array (you) with custom information! 👩‍🎨👨‍🎨
...
Create a function called `
      ...
      data ` and uses a for..in loop to format and console.log data like the example above. 
...
/* STRETCH 2: Create a function called `
